...
const TELEMETRY_URL: &str = "wss://telemetry.mvs.org/submit/";
...
pub fn local_testnet_testnet_config() -> Result<ChainSpec, String> {
  let wasm_binary = WASM_BINARY.ok_or("Development wasm binary not available".to_string())?;
  ...
  Ok(ChainSpec::from_genesis(
    ...
    // ID
    "testnet",
    ChainType::Custom(String::from("testnet")),
    move || testnet_genesis(
      wasm_binary,
      // Initial PoA authorities
      vec![
        ...
        // subkey inspect "$SECRET//hyperspace//1//validator"
        // subkey inspect "$SECRET//hyperspace//1//babe"
        // subkey inspect --scheme ed25519 "$SECRET//hyperspace//1//grandpa"
        // subkey inspect "$SECRET//hyperspace//1//imonline"
        // subkey inspect "$SECRET//hyperspace//1//discovery"
        (
        ...
        // subkey inspect "$SECRET//hyperspace//2//validator"5FNQoCoibJMAyqC77og9tSbhGUtaVt51SD7GdCxmMeWxPBvX
        // subkey inspect "$SECRET//hyperspace//2//babe"
        // subkey inspect --scheme ed25519 "$SECRET//hyperspace//2//grandpa"
        // subkey inspect "$SECRET//hyperspace//2//imonline"
        // subkey inspect "$SECRET//hyperspace//2//discovery"
        (
        ...
        // subkey inspect "$SECRET//hyperspace//3//validator"
        // subkey inspect "$SECRET//hyperspace//3//babe"
        // subkey inspect --scheme ed25519 "$SECRET//hyperspace//3//grandpa"
        // subkey inspect "$SECRET//hyperspace//3//imonline"
        // subkey inspect "$SECRET//hyperspace//3//discovery"
        (
      ...
      // subkey inspect "$SECRET//hyperspace//root"
    ...
    // Bootnodes
    vec![
      "/dns/seed1.testnet-cc2.hyperspacenode.com/tcp/30333/p2p/12D3KooWPb5VY3dzydLFVh4Bn8sk73QvicvVoYcHQawRgicuMNwJ"
        .parse()
        .unwrap(),
      "/dns/seed2.testnet-cc2.hyperspacenode.com/tcp/30333/p2p/12D3KooWG4jPV345wrEE23tdRh69i9YH5BtSo8RhToPj4fTaJgkZ"
        .parse()
        .unwrap(),
    ],
    // Telemetry
