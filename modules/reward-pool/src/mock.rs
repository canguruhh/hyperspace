...
parameter_types! {
  pub const GetNativeCurrencyId: CurrencyId = CurrencyId::ETP;
}
...
parameter_types! {
  pub const RewardPoolModuleId: ModuleId = ModuleId(*b"etp/repm");
}
  ...
  fn default() -> Self {
    ...
    Self {
      endowed_accounts: vec![
        (alice.clone(), ETP, 1_000_000_000_000_000_000u128),
        (bob.clone(), ETP, 1_000_000_000_000_000_000u128),
  ...
  pub fn build(self) -> sp_io::TestExternalities {
    ...
    pallet_balances::GenesisConfig::<TestRuntime> {
      balances: self
        ...
        .clone()
        .into_iter()
        .filter(|(_, currency_id, _)| *currency_id == ETP)
