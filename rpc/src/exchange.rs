...
pub use hyperspace_rpc_runtime_api::CurrencyExchangeApi as CurrencyExchangeRuntimeApi;
...
pub trait CurrencyExchangeRpc<BlockHash, AccountId, CurrencyId, Balance, Rate, Share> {
  #[rpc(name = "hyperspace_targetAmountAvailable")]
  ...
  #[rpc(name = "hyperspace_supplyAmountNeeded")]
  ...
  #[rpc(name = "hyperspace_getLiquidity")]
  ...
  #[rpc(name = "hyperspace_getExchangeRate")]
  fn get_exchange_rate(&self, at: Option<BlockHash>) -> Result<Rate>;

  #[rpc(name = "hyperspace_toAddLiquidity")]
  ...
  #[rpc(name="hyperspace_getAccountStakingInfo")]
